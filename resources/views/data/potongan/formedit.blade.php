...
<div class="sidebar sidebar-right sidebar-animate" style="width: 25em;">
    <div class="panel panel-primary card mb-0 box-shadow">
        ...
        <div class="panel-body tabs-menu-body latest-tasks p-0 border-0 p-3">
            <form action="{{ route('potongan.update',$id) }}" class="formUpdate" method="POST">
                @csrf
                <div class="form-group">
                    <label>Nama Potongan</label>
                    <input class="form-control" placeholder="Nama Potongan" type="text" name="nm_pot" value="{{ $row->nm_pot }}">
                </div>
                <div class="form-group">
                    <label>Keterangan Potongan</label>
                    <textarea name="ket_pot" class="form-control" cols="2" rows="3">{{ $row->ket_pot }}</textarea>
                </div>
